...
import { Flame, Twitter, Linkedin, Headphones, Calendar, Database, ArrowRight, Brain, Target, Clock } from 'lucide-react';
    ...
    <div className="min-h-screen bg-black text-white font-sans relative">
      ...
      <section className="min-h-[50vh] flex flex-col items-center justify-center pt-20">
        <div className="text-center mb-12">
          ...
          <h1 className="text-6xl font-bold mb-4 tracking-wide">AI Automation Services</h1>
          <p className="text-2xl text-gray-400 mb-8 tracking-wide">Automate Your Business with Powerful AI Solutions</p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="feature-card bg-black/40 backdrop-blur-sm p-8 rounded-xl border border-orange-500/20 hover:border-orange-500/40 transition-colors">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-bold mb-4">AI Customer Support Agent</h3>
            ...
            <div className="feature-card bg-black/40 backdrop-blur-sm p-8 rounded-xl border border-orange-500/20 hover:border-orange-500/40 transition-colors">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-bold mb-4">AI Appointment Scheduling</h3>
                <p className="text-gray-400 leading-relaxed">
            ...
            <div className="feature-card bg-black/40 backdrop-blur-sm p-8 rounded-xl border border-orange-500/20 hover:border-orange-500/40 transition-colors">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-bold mb-4">AI Lead Capture + CRM</h3>
                <p className="text-gray-400 leading-relaxed">
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="feature-card bg-black/40 backdrop-blur-sm p-8 rounded-xl border border-orange-500/20 hover:border-orange-500/40 transition-colors">
              <div className="flex flex-col h-full">
                <p className="text-gray-400 mb-6 flex-grow">
                  "The AI automation tools have transformed our lead generation process. We've seen a 300% increase in qualified leads and our customer support team is now more efficient than ever."
                </p>
            ...
            <div className="feature-card bg-black/40 backdrop-blur-sm p-8 rounded-xl border border-orange-500/20 hover:border-orange-500/40 transition-colors">
              <div className="flex flex-col h-full">
                <p className="text-gray-400 mb-6 flex-grow">
                  "The AI-driven lead qualification system is brilliant. It's like having an entire sales team working 24/7 to identify our best prospects."
                </p>
            ...
            <div className="feature-card bg-black/40 backdrop-blur-sm p-8 rounded-xl border border-orange-500/20 hover:border-orange-500/40 transition-colors">
              <div className="flex flex-col h-full">
                <p className="text-gray-400 mb-6 flex-grow">
                  "Implementing their AI chatbot was a game-changer. Customer satisfaction scores improved by 60% and support tickets decreased significantly."
                </p>
        ...
        <div className="container mx-auto">
          <div className="feature-card bg-black/40 backdrop-blur-sm p-12 rounded-xl border border-orange-500/20 hover:border-orange-500/40 transition-colors">
            ...
            <div className="space-y-6 text-gray-400">
              <p>
                At Ignite Motion, we don't just automate your business—we revolutionize how it operates. Our AI-driven solutions ensure that your workflow is optimized, your customer interactions are seamless, and your time is spent where it matters most.
              </p>
              <p>
                With cutting-edge technology and a deep understanding of business automation, we provide real, measurable results. Whether it's AI-powered customer support, advanced lead capture, or smart scheduling, we craft solutions tailored to maximize your growth and efficiency.
              </p>
            </div>
          </div>
        </div>
